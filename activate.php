...
<div class='chargeback_plugin_main_body'>
  ...
  <div class="chargeback_plugin_left chargeback_plugin_right_copy">
	...
	<div class="columns"><a href="<?php echo $return_url; ?>" target="" onclick="cbDelayRedirectToModule();"  class='chargeback_plugin_button'>Login or Create Your Chargeback Account</a></div>
  </div>
