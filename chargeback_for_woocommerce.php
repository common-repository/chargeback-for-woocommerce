...
class WC_CBCO_Chargeback {
  ...
  public static function cb_admin_notices() {
      if (get_transient('activate_notice_cbwoo') && is_plugin_active("chargeback-for-woocommerce/chargeback.php")) {
          echo "<div class='notice notice-success is-dismissible'><p>Chargeback is almost setup. To start, <a href='admin.php?page=chargeback-for-woocommerce'>Connect a Chargeback Account</a>.</p></div>";
      }
  }

  public static function cbco_cb_scripts() {
      $plugin_dir = plugin_dir_url( __FILE__);
      wp_enqueue_style( 'cbco_cb_stylesheet', $plugin_dir . "includes/cb_style.css" );
      wp_enqueue_script( 'cbco_cb_js_re', $plugin_dir . "includes/cb_refresh.js", array(), '1.0.0', true );
  }

  public static function add_settings_link($links, $file) {
      static $this_plugin;
      $this_plugin = "chargeback-for-woocommerce/chargeback.php";
      if ($file == $this_plugin){
        $settings_link = '<a href="admin.php?page=chargeback-for-woocommerce">'.__("Settings", "chargeback").'</a>';
